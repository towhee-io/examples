...
class PenaltyBuilder(object):
    ...
    def _coverage_penalty(self, cov_pen):
        if cov_pen == "wu":
            ...
            raise NotImplementedError(f"No '{cov_pen}' coverage penalty.")
    ...
    def _length_penalty(self, length_pen):
        if length_pen == "wu":
            ...
            raise NotImplementedError(f"No '{length_pen}' length penalty.")
    ...
    def length_average(self, cur_len):
